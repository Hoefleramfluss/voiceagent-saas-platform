...
const resources = {
  de: {
    translation: {
      ...
      "usage": "Nutzung",
      "logout": "Abmelden",
      "usageAnalytics": "Nutzung & Analytik",
      ...
      "signInToAccount": "Anmelden zu Ihrem Konto",
      "enterCredentials": "Geben Sie Ihre Anmeldedaten ein, um auf Ihr Dashboard zuzugreifen",
      "startToday": "Beginnen Sie noch heute mit der VoiceAgent-Plattform",
      "createAccountButton": "Konto erstellen",
      "platformDescription": "Die vollständige Plattform für Voice-Bot-Management",
      "fullVoiceBotPlatform": "Vollständige Voice-Bot-Plattform",
      "multiTenantArchitecture": "Multi-Mandanten-Architektur",
      "customerManagement": "Kundenverwaltung",
      "usageTracking": "Nutzungserfassung & Abrechnung",
      "automatedDeployment": "Automatisierte Bot-Bereitstellung",
      ...
      "voiceBotConfiguration": "Voice-Bot-Konfiguration",
      "speechToText": "Sprache-zu-Text",
      "textToSpeech": "Text-zu-Sprache",
      "testing": "Testen...",
      "testVoiceBot": "Voice-Bot testen",
      "configure": "Konfigurieren",
      "retrySetup": "Einrichtung wiederholen",
      "setupInProgress": "Einrichtung läuft...",
      "botId": "Bot-ID",
      "notAssigned": "Nicht zugewiesen",
      "voiceBotTestSuccessful": "Voice-Bot-Test erfolgreich",
      "voiceBotTestSuccessfulDesc": "Ihr Voice-Bot reagiert korrekt auf Testanrufe.",
      "voiceBotTestFailed": "Voice-Bot-Test fehlgeschlagen",
      "voiceBotTestFailedDesc": "Es gab ein Problem beim Testen Ihres Voice-Bots.",
